...
```csv
protocol,feature_names,uses_raw_timestamp,uses_arbitration_id,uses_subdivided_data_bytes,uses_intact_data_field,uses_safe_deltas,uses_future_info,normalization,encoding,notes
