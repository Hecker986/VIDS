...
```csv
model,parameter_set,parameters_json,label_mapping_rule,threshold_rule,uses_validation,notes
BIRCH,default_sklearn,"{""n_clusters"": null, ""threshold"": 0.5}",validation_majority_or_distance_threshold,validation_f1,True,cluster-to-label mapping must not use test labels
...
MLP,default_sklearn,"{""activation"": ""relu"", ""hidden_layer_sizes"": [100], ""max_iter"": 200, ""random_state"": 42, ""solver"": ""adam""}",not_applicable,validation_f1,True,paper exact parameters unavailable locally
