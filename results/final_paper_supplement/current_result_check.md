...
Checked 171 CSV/TEX/SVG/MD files from attack_centric_final, metric_correction_paper and final_grain_can.

Failures or empty files: 0.

Main-paper-ready assets detected: 50.
