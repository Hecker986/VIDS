...
5. Close 0.998 matching hypotheses observed in local rows: {'weighted_f1': 4, 'normal_f1': 1}. BIRCH specifically is not explained by deployable validation mapping; its unsafe test-majority mapping cannot be verified because cluster assignments were not saved.
